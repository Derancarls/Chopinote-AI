#!/bin/bash
# v0.3.2 预处理恢复 — 从 Stage 3 继续 (Stage 1+2 已完成)
# 后台: nohup bash scripts/preprocess/resume_v4.sh &> /root/autodl-tmp/resume_v4.log &
set -e
...
log "============================================================"
log "预处理 v4 恢复 (Stage 3-6)"
log "============================================================"

# ── Stage 3: MIDI (resume) ────────────────────────────────────
log "Stage 3/6: MIDI → tokens_v4 (25 workers, resume)"
